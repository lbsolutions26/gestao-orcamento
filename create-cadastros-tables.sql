...
CREATE UNIQUE INDEX IF NOT EXISTS contacts_family_kind_name_uniq
    ON public.contacts (family_id, kind, lower(name));
...
CREATE UNIQUE INDEX IF NOT EXISTS categories_family_type_name_uniq
...
CREATE UNIQUE INDEX IF NOT EXISTS payment_methods_family_name_uniq
    ON public.payment_methods (family_id, lower(name));
